...
#             events = tree.iter(tag='event_mention')
#             apf_count = len(list(events))

#             filename = filename[:filename.find(".apf.xml")]
#             with open("D:/ACE/anno_event_json/" + filename + ".json", "r", encoding='utf-8') as load_f:
#                 event_list = json.load(load_f)
#             json_count = len(event_list)

#             if json_count != apf_count:
#                 print (filename, apf_count, json_count)
# print (apf_count, json_count) # 5349
